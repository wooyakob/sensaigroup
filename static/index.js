document.addEventListener('DOMContentLoaded', (event) => {
  let lastObjection = "";
    ...
    if ('webkitSpeechRecognition' in window) {
      ...
      recognitionObjection.lang = 'en-US'; 
...
$('#objection-advice-btn, #product-objection-advice-btn, #product-advice-btn').click(function() {
  ...
  $(document).ready(function(){
    ...
    $('#objection-input').on('input', function () {
      this.style.height = 'auto';
      this.style.height = (this.scrollHeight) + 'px';
  });

    $('#user-answer-input').on('input', function () {
      this.style.height = 'auto';
      this.style.height = (this.scrollHeight) + 'px';
  });

    $('#product-objection-input').on('input', function () {
      this.style.height = 'auto';
      this.style.height = (this.scrollHeight) + 'px';
  });

  $('#product-advice-input').on('input', function () {
      this.style.height = 'auto';
      this.style.height = (this.scrollHeight) + 'px';
  });