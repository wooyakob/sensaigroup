...
def product_objection_advice():
    ...
    instructions = """You will respond in English. You will respond in an informal conversational manner. You will be polite and professional but not too formal or corporate.\n\n"
...
def product_advice():
    ...
    instructions = """You are a knowledgeable sales rep for the product in question. Answer the user's question about the product accurately and succinctly using the product context when relevant."""
