...
products = [
...

    {
        ...
        'design_rationale': """Paragon 28® captured the essence of surgeon concerns with the Lapidus procedure by addressing them with several patented features:
        a medially positioned plate, a ramped plate proximally to avoid tendon irritation, anatomic curvature of the plate to provide a bent plate advantage,
        a plantar locking arm to better resist the tension side of the joint, and a Precision® Guide Lapidus for crossing screw insertion to avoid collision with the locking plate screws."""
    },

    {
        'product_name': "Lapidus Cut Guide System",
        'product_info': """The Lapidus Cut Guide System was created to provide a reproducible and streamlined means to achieve calculated bi-planar correction with transverse cuts,
        or tri-planar correction with the surgeons preferred method of de-rotation.
    ...
    {
        'product_name': "Gorilla Lisfranc Plating System",
        'product_info': """The design of the Gorilla Lisfranc Plating System began with taking a close look at the unique anatomy in the area of the Lisfranc joint. The plates were designed around creating several solutions for surgeons so that an option is available for patients of varying sizes and shapes with differing diagnoses. 
        Each of the plates in the Gorilla Lisfranc Plating System are contoured to match the convexity of the Lisfranc joint. Dual ray plates are available for either the 1st and 2nd metatarsals, or the 2nd and 3rd metatarsals. Single ray options include a Slanted T-Plate, a Slanted Straight Plate and a Clover Plate. Each of these plates mentioned previously have several individual size options to fit different sized patients. 
        All Lisfranc circular plate holes accept 2.7 mm, 3.5 mm and 4.2 mm locking or non-locking screws to fit the variable anatomy in this area. Compression ramps are available on the Lisfranc Plates, accepting either a 4.2 mm compression screw, or any size non-locking screw."""
    },
]
